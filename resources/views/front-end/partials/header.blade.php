                        ...
                        <ul>                                          
                            <li><span>Language</span> <a href="#">English<i class="lnr lnr-chevron-down"></i></a>
                                ...
                                <ul class="ht-dropdown">
                                    <li><a href="#"><img src="{{url('front-end/img/header/1.jpg')}}" alt="language-selector">English</a></li>
                                    <li><a href="#"><img src="{{url('front-end/img/header/2.jpg')}}" alt="language-selector">Francis</a></li>
                                </ul>
                                <!-- Dropdown End -->
                            </li>
                    ...
                    <div class="row align-items-center no-gutters">
                        <div class="col-lg-3 col-md-12">
                            <div class="logo mb-all-30">
                                <a href="{{route('frontend.home')}}"><img src="{{url('front-end/img/logo/logo.png')}}" alt="logo-image"></a>
                            </div>
                        </div>
                                        ...
                                        <ul class="ht-dropdown cart-box-width">
                                            <li>
                                                ...
                                                <div class="single-cart-box">
                                                    <div class="cart-img">
                                                        <a href="#"><img src="{{url('front-end/img/products/1.jpg')}}" alt="cart-image"></a>
                                                ...
                                                <div class="single-cart-box">
                                                    <div class="cart-img">
                                                        <a href="#"><img src="{{url('front-end/img/products/2.jpg')}}" alt="cart-image"></a>
                                                        <span class="pro-quantity">1X</span>
                                                    </div>
                                                    <div class="cart-content">
